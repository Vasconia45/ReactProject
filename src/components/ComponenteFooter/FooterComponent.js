...
export const FooterComponent = () => {
    return (
        <footer className="mt-3 test text-center text-lg-start text-white w-100"
            id="contact">
                ...
                <section className="">
                    <div className="row">
                        ...
                        <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                            <h6 className="texto text-uppercase mb-4 font-weight-bold">
                                Nombre de compañia
                            </h6>
                            <p>
                                La Vascongada
                        ...
                        <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                            <h6 className="texto text-uppercase mb-4 font-weight-bold">Contact</h6>
                            <p><i className="fas fa-envelope mr-3"></i> lvsgada@gmail.com</p>
                            <p><i className="fas fa-phone mr-3"></i>Number</p>
                            <p><i className="fas fa-print mr-3"></i>123 456 78</p>
                        </div>

                        {/* Footer:parte derecha */}
                        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                            <h6 className="texto text-uppercase mb-4 font-weight-bold">Siguenos</h6>
